...
/**
 * Adapter from Record to MapAccessor.
 * <p>
 * This class can be used in conjunction with neo4jClient
 * to implement a custom mapping function between
 * a neo4j record and an entity (with all its relations
 * available from the record resolved).
 * <p>
 * Sample usage:
 * <pre>
 * {@code
 ...
 *     .mappedBy((t, r) -> {
 *       // entity and all its relations are mapped
 ...
 * }
 * </pre>
 * This class originates from Spring Data Neo4j
 */
